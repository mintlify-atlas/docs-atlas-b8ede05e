...
description: "Spring Community stores event banners and participant profile images on the local filesystem. Learn about the storage layout, path configuration, and how images are served."
---

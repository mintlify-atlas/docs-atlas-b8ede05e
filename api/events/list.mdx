---
title: "GET /api/eventos — List All Events"
sidebarTitle: "List Events"
description: "GET /api/eventos returns all events as EventoPrincipalDTO summaries. GET /api/eventos/mis-eventos returns only the authenticated participant's events."
---

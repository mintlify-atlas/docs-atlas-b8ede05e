---
title: "Delete an Event — DELETE /api/eventos/delete/{id}"
sidebarTitle: "Delete Event"
description: "Permanently remove a community event and all its participant and administrator associations. Returns 200 OK with an empty body on success."
---

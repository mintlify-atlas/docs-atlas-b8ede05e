---
title: "GET /api/eventos/{id} — Get Event Details"
sidebarTitle: "Get Event"
description: "GET /api/eventos/{id} — retrieves full event details including participant IDs, admin IDs, and all event metadata as an EventoDTO object."
---

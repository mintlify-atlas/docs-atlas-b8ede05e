---
title: "PUT /api/eventos/modificar/{id} — Update an Event"
sidebarTitle: "Update Event"
description: "PUT /api/eventos/modificar/{id} — updates an existing event's fields and optionally replaces its image. Accepts multipart/form-data. Returns the updated EventoDTO."
---

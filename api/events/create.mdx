---
title: "Create New Spring Community Event — POST /api/eventos"
sidebarTitle: "Create Event"
description: "Submit a multipart/form-data request with an 'evento' JSON part and optional banner image to create an event. Returns the full EventoDTO."
---

...
description: "Fetch event chat history via REST and send messages in real time over STOMP WebSocket. Covers GET /api/eventos/{eventoId}/mensajes and /ws-chat."
---

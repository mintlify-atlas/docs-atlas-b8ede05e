---
title: "POST /auth/logout — Revoke Tokens and End User Session"
sidebarTitle: "Logout"
description: "Revokes all active JWT tokens for the authenticated user, clearing the server-side security context. The client must discard both tokens after logout."
---

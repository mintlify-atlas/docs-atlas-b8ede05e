---
title: "POST /auth/crear — Register a New User"
sidebarTitle: "Register"
description: "POST /auth/crear — creates a new user account and participant profile, then returns a JWT access token and refresh token pair."
---
...
| `400 Bad Request` | Duplicate `nombre` or `email` — a user with the same username or email address already exists in the database. |
